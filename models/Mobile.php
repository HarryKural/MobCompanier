<?php
  ...
  class Mobile extends ActiveRecord\Model {
    ...
    static $belongs_to = array( 'company' );
    ...
    static $validates_uniqueness_of = array(
      array( array( 'name', 'company_id' ), 'message' => 'exists for this company already.' )
    );

    public function validate () {
      // validate the presence of the company in the database
      if ( Company::exists( $this->company_id ) === false ) {
        $this->errors->add( 'company_id', "doesn't exist." );
      }
